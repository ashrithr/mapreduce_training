 ...
 * except that instead of a separator character between the key and value, the key
...
public class FixedWidthColumnRecordWriter<K,V> extends RecordWriter<K, V> {
    ...
    public FixedWidthColumnRecordWriter(DataOutputStream out, int columnWidth) {
        this.out = out;
