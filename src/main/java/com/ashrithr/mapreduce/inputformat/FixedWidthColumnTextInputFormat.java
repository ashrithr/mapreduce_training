...
public class FixedWidthColumnTextInputFormat extends FileInputFormat<Text,Text> {
    ...
    public RecordReader<Text, Text> createRecordReader(InputSplit split, TaskAttemptContext context) throws IOException,
        ...
        RecordReader<Text,Text> recordreader = (RecordReader<Text, Text>) new FixedWidthColumnTextRecordReader();
        recordreader.initialize(split, context);
        return recordreader;
    }

    @Override
    protected long computeSplitSize(long blockSize, long minSize, long maxSize) { //run on client
